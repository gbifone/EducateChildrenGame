...
/**
 * Created by Cem Galioğlu on 12/07/2017.
 */
public class FloatLabeledTextView extends LinearLayout {
    ...
    private void initialize() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.view_floating_labeled_text_view, this);

        hintTextView = (TextView) view.findViewById(R.id.FloatLabeledEditTextHint);
        editText = (TextView) view.findViewById(R.id.FloatLabeledTextView);
    ...
    public void setTextSize(float size) {editText.setTextSize(size);}
